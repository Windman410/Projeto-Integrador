    ...
    public class PlanoDeEnsinoBean implements Serializable {
        ...
        private List<PlanoDeEnsinoBean> carregarPlanoDeEnsino;
        private PlanoDeEnsinoBean selectedCronograma;
        ...
        public PlanoDeEnsinoBean getSelectedCronograma() {
            return selectedCronograma;
        }

        public void setSelectedCronograma(PlanoDeEnsinoBean selectedCronograma) {
